...
def recordToInsertQuery (record):
    return f"insert into public.{bucket} (day_of_service, block_id, datetime, delay, psg_up, psg_down) \
        values ('{record['day_of_service']}', {record['block_id'] or 'NULL'}, '{record['datetime']}'::timestamp, {record['delay'] or 'NULL'}, {record['psg_up'] or 'NULL'}, {record['psg_down'] or 'NULL'});"
