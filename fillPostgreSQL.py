...
def recordToInsertQuery (record):
    return f"insert into public.{bucket} (day_of_service, route_id, trip_id, stop_id, block_id, datetime, delay, psg_up, psg_down) values {record['day_of_service']}, {record['route_id']}, {record['trip_id']}, {record['stop_id']}, {record['block_id']}, {record['datetime']})"
